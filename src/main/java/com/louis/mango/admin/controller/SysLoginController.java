...
import com.louis.mango.admin.util.JwtAuthenticatioToken;
...
import com.mango.mango.common.utils.IOUtils;
...
public class SysLoginController {
    ...
    public HttpResult login(@RequestBody LoginBean loginBean, HttpServletRequest request) {
        ...
        // 系统登录认证
        JwtAuthenticatioToken token = SecurityUtils.login(request, username, password, authentication);
